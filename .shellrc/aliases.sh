...
alias ...="cd ../.."
alias ..="cd .."
alias bat="batcat --style=header --paging=never --wrap=never"
alias bbb="${SCRIPTS_DIR}/terminal/bbb.sh"
alias bless="batcat --paging=always --wrap=never"
alias c="cargo"
alias copy="${SCRIPTS_DIR}/terminal/copy.sh"
alias cwd='pwd | copy'
...
alias gil="git l"
alias gip="git pull"
alias gipp="git stash && gip && git stash pop"
...
alias kk="kustomize"
alias kkk="kustomize build --enable-helm"
...
alias tpaste="${SCRIPTS_DIR}/terminal/paste.sh"
